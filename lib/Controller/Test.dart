...
//       var response = await transactionListData(debitdata.accesstoken.toString(),
...
//   }
//
//   Future<TransactionResponse> transactionListData(String accesstoken, String accountid, int currentmonth) async {
//     String startdate = "";
//     String enddate = "";
...
//     cname = transactionlist[0].category.toString();
//     final response4 =
...
// //   savedataRequest.amount = 0.0;//double.tryParse(amountinput.text)!;
...
// //   // print(cname);
// //   print(accesstoken);
// //   print('<<<<<<<<<<<<<<save bb Request body----->>>>>>>>>>>>22: ${jsonEncode(savedataRequest)}');
