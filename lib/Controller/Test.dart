...
//         bankdatalist = List<BankData>.from(dicData.map((i) => BankData.fromJson(i)));
//       }
//       // print('&&&&&&&&');
//       // print(bankdatalist.length);
...
//
//
//   Future<GetBankDataResponse> fetchBankData() async {
//
//     UserDetail tempuserdetail = await Constants.getUserDetail();
//     String banktoken = tempuserdetail.accessToken.toString();
//     final response = await http.get(Uri.parse(Constants.baseUrl2 + '/Bank/GetBankData'),
...
//       print('####manage bankdata Response <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<${jsonEncode(response)}');
//
...
//     saveBankDataRequest.id = 1;
//     saveBankDataRequest.accountid = "";
//     saveBankDataRequest.accesstoken = "";
//     saveBankDataRequest.accountname = "";
//     saveBankDataRequest.mask = "";
//     saveBankDataRequest.banklogo = "";
//     saveBankDataRequest.bankthemecolor = "bcolor";
//     saveBankDataRequest.userid = 1;
//     saveBankDataRequest.createdOn = "on";
//     saveBankDataRequest.publictoken = "";
//     saveBankDataRequest.type = 1;
//     saveBankDataRequest.userid = 1;
