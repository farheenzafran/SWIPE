class LiabilityInstitutionResponse {
  Institution? institution;
  String? requestId;

  LiabilityInstitutionResponse({this.institution, this.requestId});

  LiabilityInstitutionResponse.fromJson(Map<String, dynamic> json) {
