      ...
      child: TextButton(
        ...
        onPressed: () {
          ...
          Navigator.of(context, rootNavigator: false).push(MaterialPageRoute(
              builder: (context) => AddAccount1(), maintainState: false));
  ...
  buttonsuccesful() {
    return Container(
      ...
      child: Align(
        ...
        child:
            Image.asset('asset/images/accadd.png', width: 300.0, height: 150.0),
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Text(
              "You have sent the invitation to the account",
              style: TextStyle(
          ...
          Container(
            ...
            child: Text(
              "Once the invited member accept your invitation, you can authorize the certain card for him.",
              style: TextStyle(
