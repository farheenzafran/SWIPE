          ...
          InkWell(
            onTap: () {
             // Navigator.pop(context);
                Navigator.pop(context, MaterialPageRoute(builder: (context) => AddAccount1()),);
    ...
    return Column(
      children: [
        ...
        Container(
          height: 80,
          child: Container(
            margin: EdgeInsets.only(right: 20, left: 15, top: 8, bottom: 5),
            child: Container(
              height: 35,
              width: double.infinity,
              //color: Colors.white,
        ...
        Container(
          padding: const EdgeInsets.only(top: 12.0, left: 15, bottom: 10),
        ...
        onPressed: () {
          ...
          if (_validate1 == false && _validate2 == false) {
            ...
            Navigator.of(context, rootNavigator: false).push(MaterialPageRoute(
                builder: (context) => AddAccountSuccessful3(),
                maintainState: false));
          } else {
            print("all filled");
          }
                            ...
                            return Card(
                              child: ListTile(
                                leading: CircleAvatar(
                                  radius: 25,
                                  backgroundImage:
                                      AssetImage('asset/images/pic.png'),
                                ),
...
//>>>>>>>>>>>>>>-------------------------API's--------------------------------->>>>>>>>>>>>>>>
Future<AddUserResponse> addUser(String countryCode, String mobilenumber,
  ...
  print(
      '<<<<<<<<<<<<<<Request body----->>>>>>>>>>>>: ${jsonEncode(addUserRequest)}');
  final response =
      await http.post(Uri.parse(Constants.baseUrl2 + '/User/AddUser'),
  ...
  if (response.statusCode == 200) {
    print(
        '####manage account Response <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<${jsonEncode(response)}');
